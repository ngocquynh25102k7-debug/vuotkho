document.addEventListener('DOMContentLoaded', () => {
  ...
  const usernameInput = document.querySelector('.login-container input[type="text"].input-field') || document.querySelector('.input-field[type="text"]');
  const passwordInput = document.querySelector('.login-container input[type="password"].input-field') || document.querySelector('.input-field[type="password"]');
  ...
  const handleLogin = (e) => {
    ...
    const account = accounts.find(acc => (acc.accountName === username || acc.email === username) && acc.password === password);
